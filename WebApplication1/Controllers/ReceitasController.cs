...
namespace WebApplication1.Controllers
{
    public class ReceitasController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,TipoReceita,FormaRecebimento,DataRecebimento,Valor,Parcelamento,NumeroParcelas,PrimeiraDataVencimento,Descricao,Observacao")] Receita receita, FormCollection form)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,TipoReceita,FormaRecebimento,DataRecebimento,Valor,Parcelamento,NumeroParcelas,PrimeiraDataVencimento,Descricao,Observacao")] Receita receita, FormCollection form)
        {
            if (ModelState.IsValid)
            {
                receita.NumeroParcelas = int.Parse(form["NumParcelas"]);
